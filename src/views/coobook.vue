...
<template>
    <div>
        <div class="content cookbook with-sidebar ">
            ...
            <h2 id="Cookbook-vs-指南" data-scroll-id="Cookbook-vs-指南" tabindex="-1" style="outline: none;"><a href="#Cookbook-vs-指南" class="headerlink" title="Cookbook vs 指南" data-scroll="">Cookbook vs 指南</a></h2><p>这份 cookbook 和指南的不同之处在哪里？存在的意义是什么？</p>
            <ul>
            ...
            <h2 id="参与-Cookbook-贡献"><a href="#参与-Cookbook-贡献" class="headerlink" title="参与 Cookbook 贡献" data-scroll="">参与 Cookbook 贡献</a></h2><h3 id="我们的目标"><a href="#我们的目标" class="headerlink" title="我们的目标" data-scroll="">我们的目标</a></h3><p>Cookbook 为开发者提供了一些示例，涵盖常见的或有趣的用例，并逐步解释更复杂的细节。我们的目标是超越一个简单的示例介绍，展现更广泛适用的概念及其注意事项。</p>
            ...
            <h3 id="基本的示例"><a href="#基本的示例" class="headerlink" title="基本的示例" data-scroll="">基本的示例</a></h3><p><em>必须的</em></p>
            <ol>
                <li>用一两句话来说明问题。</li>
            ...
            <h3 id="关于其价值的细节"><a href="#关于其价值的细节" class="headerlink" title="关于其价值的细节" data-scroll="">关于其价值的细节</a></h3><p><em>必须的</em></p>
            <ol>
            ...
            <h3 id="实际的例子"><a href="#实际的例子" class="headerlink" title="实际的例子" data-scroll="">实际的例子</a></h3><p><em>必须的</em></p>
            ...
            <h3 id="额外的上下文"><a href="#额外的上下文" class="headerlink" title="额外的上下文" data-scroll="">额外的上下文</a></h3><p><em>可选的</em></p>
            <p>为这个模式写点东西，描述在这个模式下，它会应用到什么地方，为什么它能正常工作；以及在此基础上运行一些代码、提供一些延伸阅读材料，都是非常有帮助的。</p>
            <h3 id="何时避免这个模式"><a href="#何时避免这个模式" class="headerlink" title="何时避免这个模式" data-scroll="">何时避免这个模式</a></h3><p><em>可选的</em></p>
            ...
            <h3 id="替代方案"><a href="#替代方案" class="headerlink" title="替代方案" data-scroll="">替代方案</a></h3><p><em>可选的，除非这部分内容在之前已经提供过了</em></p>
            ...
            <h2 id="致谢"><a href="#致谢" class="headerlink" title="致谢" data-scroll="">致谢</a></h2><p>文档贡献是需要很多时间的，如果您花时间提交这部分的文档，我们将感激不尽。</p>
            ...
            <div class="footer">
                ...
                发现错误？想参与编辑？
                <a href="https://github.com/vuejs/cn.vuejs.org/blob/master/src/v2/cookbook/index.md" target="_blank">
                    在 GitHub 上编辑此页！
                </a>
            </div>
        </div>
